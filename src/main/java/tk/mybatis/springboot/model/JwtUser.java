...
public class JwtUser implements UserDetails {
    ...
    public JwtUser(Users users) {
        ...
        System.out.println("role:::" + RoleCode.getTypeByCode(users.getRole()));
        authorities = Collections.singleton(new SimpleGrantedAuthority("ROLE_" + RoleCode.getTypeByCode(users.getRole())));
    }
